...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "Matii Rooftop Experience is a restaurant website showcasing its menu, reviews, and location." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "Matii Rooftop Experience is a restaurant website showcasing its menu, reviews, and location." },
